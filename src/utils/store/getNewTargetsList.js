/** Функция проверяет, нужно ли добавлять новую цель в текущий стейт или нет */
const getNewTargetsList = (list, newItem, didWeGetAllTransactions) => {
...
export default getNewTargetsList;
